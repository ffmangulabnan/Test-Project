...
public class PasswordEncryptDecrypt {
	...
	private final String MAINPASSWORD = "TestMachinePassword";
	...
	public String createEncryptedPassword(String originalPassword) {
		try {
			SecretKeySpec key = createSecretKey(MAINPASSWORD.toCharArray(), salt, iterationCount, keyLength);
